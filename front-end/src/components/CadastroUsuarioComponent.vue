    ...
    <v-card>
      <div class="form-cadastro">
        ...
        <div class="input-container">
          <input class="input" type="text" id="nome" v-model="nome" required placeholder="Nome" />
        </div>
        <div class="input-container">
          <input
            class="input"
        ...
        <button class="button-custom" @click="cadastrarUsuario" style="margin-right: 10px">
          Cadastrar
        </button>
              ...
              <tr v-for="usuario in usuarios" :key="usuario.cdUsuario">
                ...
                <td>
                  <span
                    class="button-grid"
                    @click="
                      usuario.cdUsuario !== undefined ? excluirUsuario(usuario.cdUsuario) : null
                    "
                  >
